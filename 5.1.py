...
checks_list = [8734, 2345, 8201, 6621, 9999, 1234, 5678, 8201, 8888, 4321,
...
most_visited_worker = max(set(checks_list), key=checks_list.count)

# Вывод результатов
print(f"Сколько было выдано чеков: {total_checks}")
print(f"Сколько разных людей посетило ресторан: {unique_visitors}")
print(f"Какой работник посетил ресторан больше всех раз: {most_visited_worker}")